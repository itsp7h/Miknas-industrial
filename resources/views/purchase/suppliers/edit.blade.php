...
<div class="mb-6">
    ...
    <p class="page-subtitle"><a href="{{ route('purchase.suppliers.index') }}" class="text-blue-600 hover:underline">Suppliers</a> / Edit</p>
</div>
    ...
    <form action="{{ route('purchase.suppliers.update', $supplier) }}" method="POST">
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" name="name" value="{{ old('name', $supplier->name) }}" required class="form-input">
            </div>
