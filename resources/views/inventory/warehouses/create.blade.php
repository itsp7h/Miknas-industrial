...
<div class="mb-6">
    ...
    <p class="page-subtitle"><a href="{{ route('inventory.warehouses.index') }}" class="text-blue-600 hover:underline">Warehouses</a> / New</p>
</div>
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            <div>
                ...
                <input type="text" name="code" value="{{ old('code') }}" required
                       placeholder="e.g. WH-01" class="form-input">
            </div>
